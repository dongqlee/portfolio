...
const p3_btnMob = document.querySelector('.project03 .btn_mobile');
const p3_btnMob01 = document.querySelector('.project03 .btn_mobile01');
...
p3_btnMob.addEventListener('mouseenter', () => {
  p3_btnMob01.style.cssText = 'transition: all 0.3s; width: 180px;'
  p3_iconMob01.style.cssText = 'transition: all 0.7s 0.1s; left: 160px; opacity: 0;'
  p3_iconMob02.style.cssText = 'transition: all 0.3s 0.3s; opacity: 1;'
})
p3_btnMob.addEventListener('mouseleave', () => {
  p3_btnMob01.style.cssText = 'transition: all 0.3s; width: 50px;'
  p3_iconMob01.style.cssText = 'transition: all 0.1s 0.1s; left: 20px;'
  p3_iconMob02.style.cssText = 'transition: all 0.1s; opacity: 0;'
})
...
p3_btnGit.addEventListener('click', () => {
  window.open('https://github.com/dongqlee/project03')
})
p3_btnWeb.addEventListener('click', () => {
  window.open('https://dongqlee.github.io/project03/')
})
...
btnPro03.addEventListener('click', () => {
  modalBox03.style.display = 'block'
})

btnClose02.addEventListener('click', () => {
  modalBox02.style.display = 'none'
})
btnClose03.addEventListener('click', () => {
  modalBox03.style.display = 'none'
})
